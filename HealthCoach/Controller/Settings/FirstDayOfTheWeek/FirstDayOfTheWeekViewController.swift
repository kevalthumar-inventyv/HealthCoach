...
class FirstDayOfTheWeekViewController : UIViewController , UITableViewDelegate, UITableViewDataSource{
    let day = ["Sunday", "Monday"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.btnCheckBoxOut.setTitle(day[indexPath.row], for: .normal)
