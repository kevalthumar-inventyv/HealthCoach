//
//  DateFormateViewController.swift
//  HealthCoach
//
...
class DateFormateViewController : UIViewController , UITableViewDelegate, UITableViewDataSource{
    let dateFormates = ["MM/dd/yyyy", "dd.MM.yyyy", "dd/MM/yyyy", "dd-MM-yyyy", "yyyy-MM-dd"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.btnCheckBoxOut.setTitle(dateFormates[indexPath.row], for: .normal)
